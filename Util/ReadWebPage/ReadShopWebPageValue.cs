...
{
    public class ReadShopWebPageValue : BaseReadWebPage
    {
        ...
        {
            string userInfo = ConfigurationManager.AppSettings["swUAndP"];
        ...
        {
            string dataStr = string.Format("TextBox1={0}&TextBox2={1}", username, password);
            string content = request.HttpPost(url, dataStr);
        ...
        /// 读取商城所有的菜单URL
        /// </summary>
        public void ReadShopALLMenuURL()
        {
